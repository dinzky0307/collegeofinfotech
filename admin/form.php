   ...
   <form class="container" method="POST" action="" style="margin-top:60px;">
        ...
        <tr style="line-height: 100px;">
            <th colspan="3" style="text-align: center;">
                <h1 style="font-size: 40px; padding-top: 15px; padding-bottom: 20px;  font-family: Verdana, Geneva, Tahoma, sans-serif;">BSIT CONSULTATION</h1>
            </th>
        </tr>
        ...
        <tr style="line-height: 30px;">
            <th colspan="3">In Compliance with the Consultation Policy, this meetings is numbered:<input type="text" style="line-height: 28px; width: 30%;" class="input" id="lname" name="lname" x-model="form.meeting_number"></th>
        </tr>
        <tr style="line-height: 30px;">
            <th colspan="3"></th>
        </tr>
        ...
        <tr style="line-height: 100px;">
            ...
            <button onclick="window.print();" type="button" class="btn btn-primary">
                Print</button>
            <button type="button" class="btn btn-danger" name="cancel"><a href="list.php" style="text-decoration:none; color: white;">Back</a></button>
