...
if (isset($_POST['grade'])) {
    ...
    $conn = new mysqli('127.0.0.1', 'u510162695_infotechMCC', 'u510162695_infotechMCC', 'infotechMCC2023');
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <a href="print.php" target="_blank" class="btn btn-success pull-right"><span
                            class="glyphicon glyphicon-print" style="margin-top:px;"></span> Print</a>
                            ...
                            while ($row = mysql_fetch_array($r1)):
                                ...
                                while ($rows = mysql_fetch_array($r2)):
                                    ...
                                    <tr>
                                        ...
                                        <td><a data-toggle="modal" data-target="#exampleModal" class="edit" href="#"
                                                id="<?php echo $rows['id']; ?>"
                                                @click="addGrades(<?php echo $rows['id']; ?>)">Add Grades</a></td>
                                        <td class="text-center"><a
                                                href="data/student_model.php?q=removesubject&studid=<?php echo $id; ?>&classid=<?php echo $rows['id']; ?>"><i
                                                    class="fa fa-trash-o text-danger fa-lg confirmation"></i></a></td>
                                    </tr>
