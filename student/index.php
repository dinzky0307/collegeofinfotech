            ...
            <div class="col-lg-12">
                ...
                <form action="">
                    ...
                    <select name="semester" id="semester" class="dropbtn">
                        <option name="year_semester" value="First Semester" <?php echo isset($_GET['semester']) && $_GET['semester'] === 'First Semester' ? 'selected' : ''; ?>>First Semester</option>
                        <option name="year_semester" value="Second Semester" <?php echo isset($_GET['semester']) && $_GET['semester'] === 'Second Semester' ? 'selected' : ''; ?>>Second Semester</option>
                        <option name="year_semester" value="Summer" <?php echo isset($_GET['semester']) && $_GET['semester'] === 'Summer' ? 'selected' : ''; ?>>Summer</option>
                    </select>
