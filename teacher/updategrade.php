...
include 'connection.php';
  ...
  $total = ($prelim + $midterm + $final) / 3;
    ...
    $sql = "UPDATE studentsubject SET prelim_grade='$prelim', midterm_grade='$sub', final_grade='$final', total='$total' WHERE studid='$id'  AND year='$year' AND semester='$sem' AND section='$sec' AND SY='$ay'";
